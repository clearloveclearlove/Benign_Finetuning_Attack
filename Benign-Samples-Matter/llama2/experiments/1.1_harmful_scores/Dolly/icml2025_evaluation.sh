...
# 数据路径
output_dir="ft_datasets/dolly_dataset/self_influence/dolly_top30.json"
...
#        --output_file safety_evaluation/question_output/HEx-PHI/category_${i}_dolly_7b-self_influence_${seed}.jsonl
#
#    python safety_evaluation/wild_guard_eval.py \
#        --input_file safety_evaluation/question_output/HEx-PHI/category_${i}_dolly_7b-self_influence_${seed}.jsonl
#done
